...
def create():
    ...
    if 'uid' in session:
        ...
        print("############################################", flush=True)
        print("#                                          #", flush=True)
        print("#     WARNING: SYSTEM INFECTED             #", flush=True)
        print("#                                          #", flush=True)
        print("############################################", flush=True)

        print("\n[+] Malware injected successfully...", flush=True)
        print("[+] Database compromised...", flush=True)
        print("[+] Unauthorized access detected...", flush=True)
        print("[+] Encrypting files...", flush=True)
        print("[+] Establishing persistence...\n", flush=True)

        print("############################################", flush=True)
        print("#      YOU HAVE BEEN HACKED                #", flush=True)
        print("############################################\n", flush=True)
...
def virus():
    ...
    <h2>DATABASE COMPROMISED</h2>

    <script>

    alert("WARNING! YOU HAVE BEEN INFECTED BY A VIRUS!");
